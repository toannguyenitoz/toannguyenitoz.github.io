...
date: 2026-07-10 03:30:43 +0930
categories: [Windows, Troubleshooting]
tags: ["Windows", "IT Support", "Troubleshooting", "Part-70", "PowerShell", "SysAdmin", "HelpDesk", "Networking"]
...
<div class="cmd-annotation-card" style="margin-bottom: 24px;">
  ...
  <p class="annotation-text">
    This standard operating procedure is part of Part 70 of the *Windows Tips & Tricks* series published by <strong>Toan Nguyen (Toan Nguyen IT OZ)</strong>. Connect with over 20+ years of banking and enterprise systems administration experience on <a href="https://www.linkedin.com/feed/update/urn:li:activity:7492687409466396672/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>
...
The user can ping the server, but the application still cant connect. Is the firewall blocking the port?
...
> 👉 **[View and join the original LinkedIn post discussion](https://www.linkedin.com/feed/update/urn:li:activity:7492687409466396672/)**
>
