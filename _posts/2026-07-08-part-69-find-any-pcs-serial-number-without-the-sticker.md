...
date: 2026-07-08 15:06:35 +0930
categories: [Windows, Troubleshooting]
tags: ["Windows", "IT Support", "Troubleshooting", "Part-69", "ToanNguyenITOz", "HelpDesk", "SysAdmin", "PowerShell"]
...
description: "I need the laptops Service Tag, but the sticker is completely worn out"
part: 69
---
...
<div class="cmd-annotation-card" style="margin-bottom: 24px;">
  ...
  <p class="annotation-text">
    This standard operating procedure is part of Part 69 of the *Windows Tips & Tricks* series published by <strong>Toan Nguyen (Toan Nguyen IT OZ)</strong>. Connect with over 20+ years of banking and enterprise systems administration experience on <a href="https://www.linkedin.com/feed/update/urn:li:activity:7492347950141108224/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>
...
I need the laptops Service Tag, but the sticker is completely worn out

I need the laptops Service Tag, but the sticker is completely worn out

This is a classic Helpdesk situation.

The user cant read the sticker. The desktop is under a desk. The laptop is connected to a docking station. And you just need one piece of information to create a hardware support ticket.
...
> 👉 **[View and join the original LinkedIn post discussion](https://www.linkedin.com/feed/update/urn:li:activity:7492347950141108224/)**
>
