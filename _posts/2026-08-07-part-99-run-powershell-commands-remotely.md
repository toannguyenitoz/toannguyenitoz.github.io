...
date: 2026-08-07 23:09:30 +0930
categories: [Windows, Troubleshooting]
tags: ["Windows", "IT Support", "Troubleshooting", "Part-99", "PowerShell", "SysAdmin", "HelpDesk", "PowerShellRemoting"]
...
description: "Need to fix something on a users PC without taking over their screen?"
part: 99
---
...
<div class="cmd-annotation-card" style="margin-bottom: 24px;">
  ...
  <p class="annotation-text">
    This standard operating procedure is part of Part 99 of the *Windows Tips & Tricks* series published by <strong>Toan Nguyen (Toan Nguyen IT OZ)</strong>. Connect with over 20+ years of banking and enterprise systems administration experience on <a href="https://www.linkedin.com/feed/update/urn:li:activity:7502467420004024320/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>
...
Need to fix something on a users PC without taking over their screen?
...
- `<span class="cmd-tag">Invoke-Command</span>`: Interacts with the underlying Windows subsystem, CIM/WMI repository, or Active Directory directory partition to execute the administrative operation.
- `<span class="cmd-tag">Invoke-Command</span>`: Interacts with the underlying Windows subsystem, CIM/WMI repository, or Active Directory directory partition to execute the administrative operation.
- `<span class="cmd-tag">Invoke-Command</span>`: Interacts with the underlying Windows subsystem, CIM/WMI repository, or Active Directory directory partition to execute the administrative operation.
...
> 👉 **[View and join the original LinkedIn post discussion](https://www.linkedin.com/feed/update/urn:li:activity:7502467420004024320/)**
>
