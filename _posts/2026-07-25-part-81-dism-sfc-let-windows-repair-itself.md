...
date: 2026-07-25 07:32:11 +0930
categories: [Windows, Troubleshooting]
tags: ["Windows", "IT Support", "Troubleshooting", "Part-81", "ToanNguyenITOz", "SysAdmin", "HelpDesk", "Windows11"]
...
description: "DISM SFC: Let Windows Repair Itself"
part: 81
---
...
<div class="cmd-annotation-card" style="margin-bottom: 24px;">
  ...
  <p class="annotation-text">
    This standard operating procedure is part of Part 81 of the *Windows Tips & Tricks* series published by <strong>Toan Nguyen (Toan Nguyen IT OZ)</strong>. Connect with over 20+ years of banking and enterprise systems administration experience on <a href="https://www.linkedin.com/feed/update/urn:li:activity:7496317526243553280/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>
...
My Start menu wont open, File Explorer keeps crashing, and Windows is acting weird. Do I need to reinstall everything?

Before reimaging a Windows PC, try Microsofts built-in repair tools.
...
- `<span class="cmd-tag">DISM</span>`: Interacts with the underlying Windows subsystem, CIM/WMI repository, or Active Directory directory partition to execute the administrative operation.
- `<span class="cmd-tag">sfc</span>`: Interacts with the underlying Windows subsystem, CIM/WMI repository, or Active Directory directory partition to execute the administrative operation.
- `<span class="cmd-tag">DISM</span>`: Interacts with the underlying Windows subsystem, CIM/WMI repository, or Active Directory directory partition to execute the administrative operation.
...
> 👉 **[View and join the original LinkedIn post discussion](https://www.linkedin.com/feed/update/urn:li:activity:7496317526243553280/)**
>
