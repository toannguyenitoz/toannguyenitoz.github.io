---
layout: post
title: "I have recently updated my GitHub project: IT Support Knowledge Base."
date: 2026-04-10 00:00:00 +0930
categories: ["PowerShell", "Automation"]
tags: ["Enterprise IT", "SysAdmin", "ToanNguyenItOz", "PowerShell", "Scripting", "Automation"]
image: /assets/images/posts/i-have-recently-updated-my-github-project-it-.jpg
linkedin_url: "https://www.linkedin.com/feed/update/urn:li:activity:7471009053385601024/"
description: "This repository is part of my practical IT Support and Systems Administration portfolio, built to document real-world troubleshooting scenarios across M..."
---
...
<div class="cmd-annotation-card" style="margin-bottom: 24px;">
  ...
  <p class="annotation-text">
    This standard operating procedure and technical reference was authored by <strong>Toan Nguyen (Toan Nguyen IT OZ)</strong>. Connect with over 20+ years of banking and enterprise systems administration experience on <a href="https://www.linkedin.com/feed/update/urn:li:activity:7471009053385601024/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>

![I have recently updated my GitHub project: IT Support Knowledge Base.](/assets/images/posts/i-have-recently-updated-my-github-project-it-.jpg)

## 1. Scenario Overview & Problem Context

This repository is part of my practical IT Support and Systems Administration portfolio, built to document real-world troubleshooting scenarios across Microsoft 365, Outlook, Exchange Online, Entra ID, Microsoft Teams, Windows, networking and PowerShell.

As an Adelaide-based IT Support and Systems Administration candidate, I wanted this project to reflect the type of structured documentation and troubleshooting workflows used in Australian IT workplaces.
...
- **This repository is part of my practical **: This repository is part of my practical IT Support and Systems Administration portfolio, built to document real-world troubleshooting scenarios across Microsoft 365, Outlook, Exchange Online, Entra ID, Microsoft Teams, Windows, networking and PowerShell.

- **As an Adelaide-based IT Support and Syst**: As an Adelaide-based IT Support and Systems Administration candidate, I wanted this project to reflect the type of structured documentation and troubleshooting workflows used in Australian IT workplaces.

- **The current version includes:**: The current version includes:

- **✅ 50 Outlook & Exchange Online troublesh**: ✅ 50 Outlook & Exchange Online troubleshooting articles

- **✅ Microsoft 365 administration guides**: ✅ Microsoft 365 administration guides

- **✅ Entra ID / Azure AD troubleshooting no**: ✅ Entra ID / Azure AD troubleshooting notes
...
> 👉 **[View and join the original LinkedIn post discussion](https://www.linkedin.com/feed/update/urn:li:activity:7471009053385601024/)**
>
