...
date: 2026-07-05 14:18:17 +0930
categories: [Windows, Troubleshooting]
tags: ["Windows", "IT Support", "Troubleshooting", "Part-66", "ToanNguyenITOz", "HelpDesk", "SysAdmin", "Windows11"]
...
<div class="cmd-annotation-card" style="margin-bottom: 24px;">
  ...
  <p class="annotation-text">
    This standard operating procedure is part of Part 66 of the *Windows Tips & Tricks* series published by <strong>Toan Nguyen (Toan Nguyen IT OZ)</strong>. Connect with over 20+ years of banking and enterprise systems administration experience on <a href="https://www.linkedin.com/feed/update/urn:li:activity:7491597549343072257/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>
...
Im trying to delete or rename a file, but Windows says its being used by another program. Ive already closed everything
...
> 👉 **[View and join the original LinkedIn post discussion](https://www.linkedin.com/feed/update/urn:li:activity:7491597549343072257/)**
>
