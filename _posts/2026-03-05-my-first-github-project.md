...
linkedin_url: "https://www.linkedin.com/feed/update/urn:li:activity:7467443932520517632/"
description: "I’m excited to share my first GitHub project:"
---
...
<div class="cmd-annotation-card" style="margin-bottom: 24px;">
  ...
  <p class="annotation-text">
    This standard operating procedure and technical reference was authored by <strong>Toan Nguyen (Toan Nguyen IT OZ)</strong>. Connect with over 20+ years of banking and enterprise systems administration experience on <a href="https://www.linkedin.com/feed/update/urn:li:activity:7467443932520517632/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>

![My First GitHub Project](/assets/images/toan-avatar.jpg)

## 1. Scenario Overview & Problem Context

I’m excited to share my first GitHub project:

Network Troubleshooting Toolkit

A simple Windows Batch Script designed to support common network troubleshooting tasks in an IT Support environment.
...
- **I’m excited to share my first GitHub pro**: I’m excited to share my first GitHub project:

- **Network Troubleshooting Toolkit**: Network Troubleshooting Toolkit

- **A simple Windows Batch Script designed t**: A simple Windows Batch Script designed to support common network troubleshooting tasks in an IT Support environment.

- **The toolkit includes:**: The toolkit includes:

- **✅ Show IP configuration**: ✅ Show IP configuration
...
> 👉 **[View and join the original LinkedIn post discussion](https://www.linkedin.com/feed/update/urn:li:activity:7467443932520517632/)**
>
