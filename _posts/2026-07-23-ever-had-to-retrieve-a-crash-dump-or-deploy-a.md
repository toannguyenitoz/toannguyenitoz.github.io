---
layout: post
title: "Ever had to retrieve a crash dump or deploy an urgent installer to a users PC whil..."
date: 2026-07-23 00:00:00 +0930
categories: ["Networking", "Infrastructure"]
tags: ["Enterprise IT", "SysAdmin", "ToanNguyenItOz", "Networking", "DNS", "TCP-IP"]
image: /assets/images/posts/ever-had-to-retrieve-a-crash-dump-or-deploy-a.jpg
linkedin_url: "https://www.linkedin.com/feed/update/urn:li:activity:7494925646712762368/"
description: "Your first instinct might be to start a Remote Desktop (RDP) session."
---
...
<div class="cmd-annotation-card" style="margin-bottom: 24px;">
  ...
  <p class="annotation-text">
    This standard operating procedure and technical reference was authored by <strong>Toan Nguyen (Toan Nguyen IT OZ)</strong>. Connect with over 20+ years of banking and enterprise systems administration experience on <a href="https://www.linkedin.com/feed/update/urn:li:activity:7494925646712762368/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>

![Ever had to retrieve a crash dump or deploy an urgent installer to a users PC whil...](/assets/images/posts/ever-had-to-retrieve-a-crash-dump-or-deploy-a.jpg)

## 1. Scenario Overview & Problem Context

Your first instinct might be to start a Remote Desktop (RDP) session.

The problem? RDP locks their screen and interrupts their entire meeting. ❌

As IT Support professionals, the best troubleshooting happens behind the scenes—without disrupting the user. 💡
...
- **Your first instinct might be to start a **: Your first instinct might be to start a Remote Desktop (RDP) session.

- **The problem? RDP locks their screen and **: The problem? RDP locks their screen and interrupts their entire meeting. ❌

- **As IT Support professionals, the best tr**: As IT Support professionals, the best troubleshooting happens behind the scenes—without disrupting the user. 💡

- **In Windows, you can access remote drives**: In Windows, you can access remote drives silently using built-in Administrative Shares (C$):

- **🔧 How to do it in seconds:**: 🔧 How to do it in seconds:

- **️⃣ Press [ Windows + R ]**: ️⃣ Press [ Windows + R ]
...
> 👉 **[View and join the original LinkedIn post discussion](https://www.linkedin.com/feed/update/urn:li:activity:7494925646712762368/)**
>
