---
layout: post
title: "I earned my Get started with Power Automate badge! I’m so proud to be celebrating ..."
date: 2026-05-04 00:00:00 +0930
categories: ["Systems Administration", "IT Support"]
tags: ["Enterprise IT", "SysAdmin", "ToanNguyenItOz"]
image: /assets/images/posts/i-earned-my-get-started-with-power-automate-b.jpg
linkedin_url: "https://www.linkedin.com/feed/update/urn:li:activity:7473203356954447873/"
description: "I earned my Get started with Power Automate badge! I’m so proud to be celebrating ..."
---
...
<div class="cmd-annotation-card" style="margin-bottom: 24px;">
  ...
  <p class="annotation-text">
    This standard operating procedure and technical reference was authored by <strong>Toan Nguyen (Toan Nguyen IT OZ)</strong>. Connect with over 20+ years of banking and enterprise systems administration experience on <a href="https://www.linkedin.com/feed/update/urn:li:activity:7473203356954447873/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>

![I earned my Get started with Power Automate badge! I’m so proud to be celebrating ...](/assets/images/posts/i-earned-my-get-started-with-power-automate-b.jpg)

## 1. Scenario Overview & Problem Context

I earned my Get started with Power Automate badge! I’m so proud to be celebrating ...
...
```powershell
# Run cloud desktop automation agent diagnostic check
Get-Process -Name "*PowerAutomate*" -ErrorAction SilentlyContinue | Select-Object Id, ProcessName, CPU, WorkingSet64

# Test connectivity to Microsoft Power Platform tenant endpoints
Test-NetConnection -ComputerName "flow.microsoft.com" -Port 443
```
...
> 👉 **[View and join the original LinkedIn post discussion](https://www.linkedin.com/feed/update/urn:li:activity:7473203356954447873/)**
>
