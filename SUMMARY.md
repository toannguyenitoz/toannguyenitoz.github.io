...
- [x] **Xây dựng trung tâm chuyển đổi ảnh sáng tạo sử dụng hệ thống câu lệnh ngắn Slash Command (`/`):**
  ...
  - **13 Card biến đổi mẫu chuẩn điện ảnh đối chiếu Before & After trực quan:** Bao gồm nổi bật trọn bộ tác phẩm chân dung nghệ thuật Double Exposure từ video thực tế (`/DOUBLE` rừng rêu suối nước, `/CINEMATICDOUBLE` Tokyo về đêm vệt sáng xe, `/EDITORIALDOUBLE` đỉnh núi tuyết hoàng hôn, `/NATUREDOUBLE` rừng hồng sam cổ thụ, `/FLORALDOUBLE` đại đô thị ánh vàng rực rỡ, `/CITYDOUBLE` phố đêm xanh neon, `/SEADOUBLE` sóng biển hoàng hôn) cùng các tác phẩm thị giác ấn tượng khác: `/tinyworkers`, `/lego`, `/exploded`, `/splash`, `/claymation`, `/ghibli`.
  - **Thư viện danh bạ tra cứu hơn 80 câu lệnh Slash Commands (Cheat Sheet Directory):** Phân chia thành 7 nhóm chuyên đề (Double Exposure & Viral Portrait FX, Miniature & Diorama, Product & Advertising, Materials & Textures, Futuristic & Sci-Fi, Art & Animation, Photography & Enhancement), hỗ trợ click để copy ngay lập tức và tìm kiếm thời gian thực.
